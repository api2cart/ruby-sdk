...
# Unit tests for OpenapiClient::OrderRefund
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::OrderRefund do
  let(:instance) { OpenapiClient::OrderRefund.new }

  describe 'test an instance of OrderRefund' do
    it 'should create an instance of OrderRefund' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::OrderRefund)
    end
  end
