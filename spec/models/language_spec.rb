...
# Unit tests for OpenapiClient::Language
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::Language do
  let(:instance) { OpenapiClient::Language.new }

  describe 'test an instance of Language' do
    it 'should create an instance of Language' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::Language)
    end
  end
