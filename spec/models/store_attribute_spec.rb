...
# Unit tests for OpenapiClient::StoreAttribute
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::StoreAttribute do
  let(:instance) { OpenapiClient::StoreAttribute.new }

  describe 'test an instance of StoreAttribute' do
    it 'should create an instance of StoreAttribute' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::StoreAttribute)
    end
  end
