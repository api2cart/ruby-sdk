...
# Unit tests for OpenapiClient::CustomerAddress
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::CustomerAddress do
  let(:instance) { OpenapiClient::CustomerAddress.new }

  describe 'test an instance of CustomerAddress' do
    it 'should create an instance of CustomerAddress' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::CustomerAddress)
    end
  end
