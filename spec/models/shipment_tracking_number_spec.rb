...
# Unit tests for OpenapiClient::ShipmentTrackingNumber
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ShipmentTrackingNumber do
  let(:instance) { OpenapiClient::ShipmentTrackingNumber.new }

  describe 'test an instance of ShipmentTrackingNumber' do
    it 'should create an instance of ShipmentTrackingNumber' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::ShipmentTrackingNumber)
    end
  end
