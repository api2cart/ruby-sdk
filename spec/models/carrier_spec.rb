...
# Unit tests for OpenapiClient::Carrier
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::Carrier do
  let(:instance) { OpenapiClient::Carrier.new }

  describe 'test an instance of Carrier' do
    it 'should create an instance of Carrier' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::Carrier)
    end
  end
