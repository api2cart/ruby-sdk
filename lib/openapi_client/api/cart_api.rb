...
module OpenapiClient
  class CartApi
    ...
    # Get bridge key and store key
    # @param [Hash] opts the optional parameters
    # @return [Array<(CartBridge200Response, Integer, Hash)>] CartBridge200Response data, response status code and response headers
    def cart_bridge_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'CartBridge200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['ApiKeyAuth']

      new_options = opts.merge(
        :operation => :"CartApi.cart_bridge",
    ...
    # @param cache_type [String] Defines which cache should be cleared.
    # @param [Hash] opts the optional parameters
    ...
    # @param cache_type [String] Defines which cache should be cleared.
    # @param [Hash] opts the optional parameters
    # @return [Array<(CartClearCache200Response, Integer, Hash)>] CartClearCache200Response data, response status code and response headers
    def cart_clear_cache_with_http_info(cache_type, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'CartClearCache200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['StoreKeyAuth', 'ApiKeyAuth']

      new_options = opts.merge(
        :operation => :"CartApi.cart_clear_cache",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    # @option opts [String] :params Set this parameter in order to choose which entity fields you want to retrieve (default to 'store_name,store_url,db_prefix')
    # @option opts [String] :exclude Set this parameter in order to choose which entity fields you want to ignore. Works only if parameter &#x60;params&#x60; equal force_all
    # @return [Array<(CartConfig200Response, Integer, Hash)>] CartConfig200Response data, response status code and response headers
    def cart_config_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'CartConfig200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['StoreKeyAuth', 'ApiKeyAuth']

      new_options = opts.merge(
        :operation => :"CartApi.cart_config",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    # @param cart_config_update [CartConfigUpdate] 
    # @param [Hash] opts the optional parameters
    # @return [CartConfigUpdate200Response]
    def cart_config_update(cart_config_update, opts = {})
      data, _status_code, _headers = cart_config_update_with_http_info(cart_config_update, opts)
      data
    end
    ...
    def cart_config_update_with_http_info(cart_config_update, opts = {})
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && cart_config_update.nil?
        fail ArgumentError, "Missing the required parameter 'cart_config_update' when calling CartApi.cart_config_update"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(cart_config_update)
      ...
      new_options = opts.merge(
        :operation => :"CartApi.cart_config_update",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    # @param cart_create [CartCreate] 
    # @param [Hash] opts the optional parameters
    # @return [AccountCartAdd200Response]
    def cart_create(cart_create, opts = {})
      data, _status_code, _headers = cart_create_with_http_info(cart_create, opts)
      data
    end
    ...
    def cart_create_with_http_info(cart_create, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CartApi.cart_create ...'
      end
      # verify the required parameter 'cart_create' is set
      if @api_client.config.client_side_validation && cart_create.nil?
        fail ArgumentError, "Missing the required parameter 'cart_create' when calling CartApi.cart_create"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(cart_create)
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [Boolean] :delete_bridge Identifies if there is a necessity to delete bridge (default to false)
    # @return [Array<(CartDisconnect200Response, Integer, Hash)>] CartDisconnect200Response data, response status code and response headers
    def cart_disconnect_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'CartDisconnect200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['StoreKeyAuth', 'ApiKeyAuth']

      new_options = opts.merge(
        :operation => :"CartApi.cart_disconnect",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    # Get list of supported carts
    # @param [Hash] opts the optional parameters
    # @return [Array<(CartList200Response, Integer, Hash)>] CartList200Response data, response status code and response headers
    def cart_list_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'CartList200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['ApiKeyAuth']

      new_options = opts.merge(
        :operation => :"CartApi.cart_list",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
