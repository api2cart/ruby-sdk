...
module OpenapiClient
  ...
  class ProductAddSellerProfiles
    ...
    attr_accessor :return_profile_id
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::ProductAddSellerProfiles` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::ProductAddSellerProfiles`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'payment_profile_id')
        self.payment_profile_id = attributes[:'payment_profile_id']
      end

      if attributes.key?(:'return_profile_id')
        self.return_profile_id = attributes[:'return_profile_id']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          payment_profile_id == o.payment_profile_id &&
          return_profile_id == o.return_profile_id
    end
    ...
    def hash
      [shipping_profile_id, payment_profile_id, return_profile_id].hash
    end
