...
module OpenapiClient
  class OrderAddOrderItemInner
    ...
    attr_accessor :order_item_weight
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::OrderAddOrderItemInner` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::OrderAddOrderItemInner`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'order_item_name')
        self.order_item_name = attributes[:'order_item_name']
      else
        self.order_item_name = nil
      end

      if attributes.key?(:'order_item_model')
        self.order_item_model = attributes[:'order_item_model']
      end

      if attributes.key?(:'order_item_price')
        self.order_item_price = attributes[:'order_item_price']
      else
        self.order_item_price = nil
      end
      ...
      if attributes.key?(:'order_item_weight')
        self.order_item_weight = attributes[:'order_item_weight']
      end
      ...
      if attributes.key?(:'order_item_tax')
      ...
      if attributes.key?(:'order_item_allow_refund_items_separately')
      ...
      if attributes.key?(:'order_item_property')
