...
module OpenapiClient
  class CatalogPriceRule
    ...
    attr_accessor :uses_per_order_limit
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::CatalogPriceRule` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::CatalogPriceRule`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'uses_per_order_limit')
        self.uses_per_order_limit = attributes[:'uses_per_order_limit']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          uses_per_order_limit == o.uses_per_order_limit &&
    ...
    def hash
      [id, gid, type, name, description, short_description, avail, actions, created_time, date_start, date_end, usage_count, conditions, uses_per_order_limit, additional_fields, custom_fields].hash
    end
