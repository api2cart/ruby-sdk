  ...
  class Cart
    ...
    def self.openapi_types
      {
        ...
        :'shipping_zones' => :'Array<CartShippingZone>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::Cart` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::Cart`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'db_prefix')
        self.db_prefix = attributes[:'db_prefix']
      end

      if attributes.key?(:'stores_info')
        if (value = attributes[:'stores_info']).is_a?(Array)
          self.stores_info = value
        end
      end
      ...
      if attributes.key?(:'shipping_zones')
        if (value = attributes[:'shipping_zones']).is_a?(Array)
          self.shipping_zones = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          shipping_zones == o.shipping_zones &&
