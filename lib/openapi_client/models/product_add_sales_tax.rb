...
module OpenapiClient
  ...
  class ProductAddSalesTax
    ...
    attr_accessor :shipping_inc_in_tax
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::ProductAddSalesTax` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::ProductAddSalesTax`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'shipping_inc_in_tax')
        self.shipping_inc_in_tax = attributes[:'shipping_inc_in_tax']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          shipping_inc_in_tax == o.shipping_inc_in_tax
    end
    ...
    def hash
      [tax_percent, tax_state, shipping_inc_in_tax].hash
    end
